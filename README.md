...
We draw a dot at the point (Recall, Precision) = (0.53, 0.56) that is closest to the point (1,1). This corresponds to the choice of Threshold that gives the (Recall, Precision) pair closest to the ideal model (1,1). Below is the code to compute this pair :
